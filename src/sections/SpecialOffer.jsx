  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex-1">
        ...
        width={773}
        height={687}
        alt="" className="object-contain w-full" />
    ...
    <div className="flex flex-1 flex-col ">
      ...
      <p className="mt-4 lg:max-w-lg info-text">Embark on a shopping journey that redefines your experience with unbeatable deals. Find your perfect shoes at our unbeatable prices.</p>
